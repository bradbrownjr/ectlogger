...
- **Mute a station** — Hover a message from a station you'd rather not see (spam, off-topic chatter) and click the mute icon next to Reply. Their messages stop appearing for you immediately; nobody else's view changes, and the net log is unaffected. A banner appears above chat whenever you have anyone muted, showing how many and letting you unmute from there.
