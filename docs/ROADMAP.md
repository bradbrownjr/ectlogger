...
*Last updated: 2026-07-06 (rev 36 — Step 4 frontend page splits DONE for Admin, CreateSchedule, CreateNet, Dashboard, Scheduler, NetView (stopped short of the ~800-line target by deliberate decision — see NetView row; every risky/duplicated surface is extracted and browser-validated). Profile.tsx also DONE (1,078 -> 193 lines, browser-validated). Next: NCSStaffModal.tsx.)*  
...
**Step 4 — Frontend page splits** *(easiest first; NetView + Profile.tsx done, NCSStaffModal.tsx next)*  
