...
password is only useful as a fallback for when email delivery is unavailable. Administrator
accounts additionally require two-factor authentication (a code from an authenticator app).
