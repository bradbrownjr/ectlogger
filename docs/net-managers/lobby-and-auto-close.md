...
When a net is within 15 minutes of its computed auto-close time, anyone viewing it sees a dismissible warning banner first — enough notice to keep it open by simply checking in or sending a chat message if it shouldn't close yet.
