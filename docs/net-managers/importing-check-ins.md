...
If a net ran off-app, on paper or in a spreadsheet or in another logging program, you don't have to leave that history out of ECTLogger. The **Import** button, in the toolbar of any net you can manage, reads a CSV file and creates a check-in for every row.
