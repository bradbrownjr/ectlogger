...
<figure>
  ...
  <figcaption>Announcements is the schedule's standing text; Notes (stored on the net as "announcements" internally) is this occurrence only. They open two different panels with two different pieces of text.</figcaption>
</figure>
...
During a live or lobby net, the **Script** button in the toolbar opens it for Net Control to read from -- it only appears once a script is actually set.
