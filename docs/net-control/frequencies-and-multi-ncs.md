...
<figure>
  ...
  <figcaption>Those coloured outlines are the app's own, not a callout on this page. Each active NCS claims a different chip, and the colour follows the operator — the same red marks W1PINE's row in the check-in list.</figcaption>
</figure>
