...
- On a closed or archived net, chips are view-only -- clicking one no longer does anything.

<figure>
  <img src="/docs/img/net-control/frequency-chips-claimed.png"
       alt="Two frequency chips in the net header, one starred as &quot;YOUR claimed frequency&quot; in W1PINE's color, the other reading &quot;W1PORT is monitoring this frequency&quot; in a second color.">
  <figcaption>Each active NCS claims a different frequency chip; the color follows the operator, not the frequency.</figcaption>
</figure>

Filtering the check-in list to one frequency never hides an active NCS's own row, regardless of which frequency they've claimed -- you can always see who's in charge no matter which slice of the net you're currently looking at.
