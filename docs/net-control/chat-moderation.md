...
Chat has two different mute controls behind the same icon, and they do genuinely different things: one is a personal filter anybody can use, the other is a real moderation action reserved for staff. Getting the difference right matters because of how far each one reaches — one changes your own screen, the other changes everybody's. Neither one tells the muted station anything.
...
- It doesn't touch anything already recorded. Reloading the chat history, and every export of the net's chat log, still returns every message unfiltered for every station — net-wide mute only affects the live broadcast and other people's live rendering, never the record.
...
<figure>
  <img src="/docs/img/net-control/muted-stations-dialog.png"
       alt="The Muted Stations dialog, listing KC1HILL under &quot;Your personal mutes&quot; with an Unmute link, above a separate &quot;Muted for everyone&quot; section reading &quot;No stations muted for everyone.&quot;">
