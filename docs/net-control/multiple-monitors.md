...
- **Detach** turns a docked panel into a draggable, resizable floating overlay that stays on top of the rest of the page — useful for pulling something out of the column layout without leaving the browser tab.
