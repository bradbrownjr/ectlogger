...
Implementation lives in:
  ...
  email/auth.py          — send_magic_link, send_password_changed, send_admin_email_change_notice
...
class EmailService:
    ...
    send_admin_email_change_notice = staticmethod(send_admin_email_change_notice)
