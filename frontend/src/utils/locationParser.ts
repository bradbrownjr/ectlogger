...
function looksLikeAddress(location: string): boolean {
  ...
  // State abbreviations at the end (e.g., "Skowhegan ME")
  ...
  // Full state names at the end (e.g., "Skowhegan Maine" or "Phillips Maine")
  ...
  if (stateNames.test(location)) return true;
